...
int main(int argc, char* argv[])
{
		...
		char *str ="{\"time\":1349688926,\
					...
					\"formula\":\"blog_tag\",\
					\"programmer\":\"shunli\",\
					\"data\":{\"blogid\":\"5f56a4640100md37\",\"blog_pubdate\":\"1282028281\",\"classid\":\"5\",\"body\":\"-\",\"keyWords\":[{\"word\":\"思科\",\"count\":19,\"tfidf\":0.7192128244436503},{\"word\":\"思科\",\"count\":47,\"tfidf\":0.27454768431526294}]}}";
		int i;
		for(i=0;i<10000;i++)		
		{
				reply = redisCommand(redis_c,"hget blog_tag %s",str);
				fprintf(stdout,"%s\r\n",reply->str);
